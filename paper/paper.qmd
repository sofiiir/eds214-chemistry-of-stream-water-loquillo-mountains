---
title: "Figure 3: Hurricane Hugo Effects on Stream Chemistry"
format: html
execute:
  message: false
  warning: false
...
Figure 3. Concentrations of potassium (k), nitrate-N, magnesium (mg), calcium (ca), and ammonium-N (Nh4-n) in four streams in the Loquillo Mountain Watershed.   The vertical lines indicate hurricane Hugo, the event of study.