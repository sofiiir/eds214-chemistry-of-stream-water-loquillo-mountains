...
The course EDS-214 titled workflows and reproducibility, emphasizes a real world example of data analysis that benefits from workflow organization and reproducible code. This course has chosen Schaefer et al.'s (2000) study analyzing the effects of Hurricane Hugo on the watersheds of the Loquillo Mountain Watershed in Puerto Rico as a case study. In this repository, figure 3 from Schaefer et al.'s (2000) paper was reproduced.
...
#source(here::here("0_environment_initialization.R"))
...
Raw data is stored in the data folder. This data was processed to include only necessary data and  analyzed for the 9-week moving averages for each of the five nutrients. These wrangled data sets are stored in the outputs folder. 

Raw data was downloaded from the [Environmental Data Initiative](https://portal.edirepository.org/nis/metadataviewer?packageid=knb-lter-luq.20.4923064), an open source environmental database.
...
The graph recreation from Schaefer et al. (2000), shows elevated levels of potassium, nitrate-n, magnesium, and calcium after Hurricane Hugo. Ammonium data was not avalable for the test dates.
...
#sourcing the ggplotting code
source(here::here("3_ggplotting.R"))
#displaying figure 3
fig3
