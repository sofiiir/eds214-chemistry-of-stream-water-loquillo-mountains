...
NEED TO FIGURE OUT HOW TO MAKE MY GRAPH APPEAR BY JUST CALLING THE PNG OR JPG Each dataframe for the individual nutrients was plotted and combined into a single graph. The graph below is as close a replica of the original graph from Schaefer et al. (2000) as possible given differences in data.
